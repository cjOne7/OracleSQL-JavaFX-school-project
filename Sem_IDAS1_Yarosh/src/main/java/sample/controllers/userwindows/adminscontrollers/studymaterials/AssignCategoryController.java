...
public class AssignCategoryController implements Initializable {
    ...
    private void addCategory(ActionEvent event) {
        OpenNewWindow.openNewWindow("/fxmlfiles/userwindows/adminsfxmls/studymaterials/AddCategoryToMaterialsWindow.fxml", getClass(), false, "Add categories to study materials window", new Image("/images/admin_icon.png"));
    }
    ...
    private void changeCategory(ActionEvent event) {
        ...
        if (studyMatCtgy == null) {
            ...
            OpenNewWindow.openNewWindow("/fxmlfiles/userwindows/adminsfxmls/studymaterials/ChangeAssignedCategoryWindow.fxml", getClass(), false, "Change assigned category(s) to study materials window", new Image("/images/admin_icon.png"));
        }
    }
